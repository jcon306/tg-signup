        ...
        <div className='header-container'>
            ...
            <div className='header-text'>
                ...
                <p>
                    ...
                    Thanksgiving Dinner. Then purchase the ingredients and drop off to 250 Braen Ave in Wyckoff on <strong>November 18th 10-12</strong> 
                    (detailed instructions will be given after signing up) to be delivered to the families. We are also in need of delivery 
                    drivers from <strong>1-3</strong> to deliver the meals (<a href="https://give.families4families.com/campaigns/28443-thanksgiving-dinner-drop-off" 
                    target="_blank" rel="noreferrer" >sign up here</a>). Suggested ingredients include: Boxed Stuffing Mix (like Stovetop), Macaroni & 
